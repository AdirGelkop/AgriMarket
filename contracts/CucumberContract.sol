...
// CucumberContract - manages cucumber growing contracts
contract CucumberContract {
    ...
    function createContract(
        ...
        // Set up milestones for cucumbers (April to August)
        newContract.milestones[0] = Milestone({
            description: "Seeding and greenhouse setup",
            deadline: 1682467200, // April 26, 2024
            payment: _totalAmount * 25 / 100, // 25% of total
            completed: false,
            approved: false
        });
        
        newContract.milestones[1] = Milestone({
            description: "Growing and watering cycle",
            deadline: 1688601600, // July 6, 2024
            payment: _totalAmount * 45 / 100, // 45% of total
            completed: false,
            approved: false
        });
        
        newContract.milestones[2] = Milestone({
            description: "Harvest and packaging",
            deadline: 1693267200, // August 29, 2024
