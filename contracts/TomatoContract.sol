...
// TomatoContract - manages tomato growing contracts
contract TomatoContract {
    ...
    function createContract(
        ...
        // Set up milestones for tomatoes (March to September)
        newContract.milestones[0] = Milestone({
            description: "Seeding and soil preparation",
        ...
        newContract.milestones[1] = Milestone({
            description: "Growing and maintenance",
            deadline: 1687824000, // June 27, 2024
            payment: _totalAmount * 40 / 100, // 40% of total
            completed: false,
            approved: false
        });
        
        newContract.milestones[2] = Milestone({
            description: "Harvest and delivery",
            deadline: 1693526400, // September 1, 2024
            payment: _totalAmount * 30 / 100, // 30% of total
            completed: false,
            approved: false
        });
